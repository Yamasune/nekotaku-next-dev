...
我们从恋爱游戏网 `一个资源下可以由若干用户贡献若干关于该资源的资源链接`, 以及 GitHub 的 `Close Pull Request, Merge Pull Request, Diff Pull Resuest Content` 中得到了巨大的灵感

CFMSC 首次被实现是在 [鲲 Galgame 论坛](https://www.kungal.com/zh-cn) 的发布 Galgame 功能上
...
再者, VNDB 对 [Galgame 是什么](https://www.kungal.com/zh-cn/topic/1720) 这件事, 做出了合理且详实的定义
...
[鲲 Galgame 论坛](https://www.kungal.com/zh-cn) - Nuxt3 实现
